...
in
{
  config = lib.mkIf (cfg.enable) {
    ...
    programs.noctalia-shell.user-templates = {
      templates = {
        yazi = {
          inputPath = "${config.xdg.configHome}/noctalia/colorschemes/yazi-theme.toml";
          outputPath = "${config.xdg.configHome}/yazi/theme.toml";
        };
      };
    };

    xdg.configFile = {
      "noctalia/colorschemes/yazi-theme.toml".text = ''
        # : Manager [[[
